...
const (
	...
	DockerQemuAction      = util.RawString("docker/setup-qemu-action@ce360397dd3f832beb865e1373c09c0e9f86d70a # v4")
	...
	TyposAction            = util.RawString("crate-ci/typos@7b04f660f4ee4f048d18fd341887cf28dfbedfe2 # v1")
