...
func GetCodeqlInitAction(isSelfHostedRunner bool) util.RawString {
	if isSelfHostedRunner {
		...
		return "github/codeql-action/init@b96794f015dfd88f77b49b1c93e0fa7110f94c63 # v4"
	}
}
...
func GetCodeqlAnalyzeAction(isSelfHostedRunner bool) util.RawString {
	if isSelfHostedRunner {
		...
		return "github/codeql-action/analyze@b96794f015dfd88f77b49b1c93e0fa7110f94c63 # v4"
	}
}
...
func GetCodeqlAutobuildAction(isSelfHostedRunner bool) util.RawString {
	if isSelfHostedRunner {
		...
		return "github/codeql-action/autobuild@b96794f015dfd88f77b49b1c93e0fa7110f94c63 # v4"
	}
}
...
const (
	...
	DockerBuildxAction    = util.RawString("docker/setup-buildx-action@594f3bf4285d9ea8dc53c9a0c9c4092420091003 # v4")
	DockerQemuAction      = util.RawString("docker/setup-qemu-action@99012661954931238ded8c8b007157a8430204e1 # v4")
	DockerBuildPushAction = util.RawString("docker/build-push-action@c3c9e263c25d99ce0380d002d59b67737d91b0dc # v7")
	...
	GoCoverageReportAction  = util.RawString("fgrosse/go-coverage-report@2eb52af4e808426e2d4edd850ff8c9ca14fce029 # v1.4.0")
	...
	TyposAction             = util.RawString("crate-ci/typos@d43b6c087ac471e2ea7b8af622ff15f05c0c365b # v1")
)
