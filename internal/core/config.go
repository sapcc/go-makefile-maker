...
// IsSAPInternalProject returns whether the project URL is below one of the
// scopes known to belong to *internal* SAP projects.
func (m Metadata) IsSAPInternalProject() bool {
	return strings.HasPrefix(m.URL, "https://github.wdf.sap.corp/") ||
